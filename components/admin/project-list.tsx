...
type Project = { id: string; title: string; slug: string; status: string; category: { id: string; name: string; sortOrder: number }; coverImage: { thumbnailUrl: string } | null; _count: { images: number } };
