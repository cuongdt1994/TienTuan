...
export async function POST(request: Request) {
  ...
  try {
    ...
    await recordAudit({ userId: user.id === "dev-admin" ? undefined : user.id, action: "CATEGORY_CREATED", entityType: "Category", entityId: category.id, metadata: { name: category.name } });
